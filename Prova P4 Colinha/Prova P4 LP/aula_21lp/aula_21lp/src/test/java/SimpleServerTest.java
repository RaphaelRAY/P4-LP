...
public class SimpleServerTest { // Especifica endereco do IP local para o servido
    ...
    public static void main(String args[]) {
        ...
        try { // Inicia servidor e cria servico de escuta por porta via socket
            iniciaServidor();
    ...
    private static void iniciaServidor() throws IOException { // Cria servico de escuta pelo servidor na porta
                                                              // especificada via socket
        servidor = new ServerSocket(PORTA);
        System.out.println("Servidor iniciado na porta " + PORTA);
    }

    private static void aguardaConexaoCliente() throws IOException { // Cria canal de comucacao para conexao do cliente
                                                                     // (servico)
        clienteAceito = servidor.accept();
        // Apresenta endereco do cliente conectado ao servidor
        System.out.println("Cliente IP: " + clienteAceito.getInetAddress().getHostAddress()
    ...
    private static void retornaMensagemCliente(String msg) throws IOException { // Servidor retorna mensagem ao Cliente
        saida.println(msg);
        System.out.print("Ecoou ao Cliente: ");
        System.out.println(msg); // Imprime na tela a mensagem de saida
    }

    private static void encerraConexaoCliente() throws IOException { // Fechando o canal de entrada do servidor e o
                                                                     // servico de conexao ao servidor
        entrada.close(); // Fecha o canal de comunicacao
        System.out.println("Cliente se desconectou do Servidor!");
    }

    private static void encerraServidor() throws IOException { // Fecha servico de escuta por porta via socket e encerra
                                                               // servidor
        servidor.close();
