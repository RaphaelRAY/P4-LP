...
public class SimpleClienteTest { // Criando a variavel de conexao do tipo Socket
    ...
    public static void main(String args[]) {
        ...
        try { // Cria Cliente e inicia conexao com Servidor via socket
            iniciaCliente();
            // Conversa com o Servidor até solicitar encerramento de comunicacao
            conversaComServidor();
    ...
    private static void iniciaCliente() throws IOException { // Cria Cliente com IP e Porta para comunicacao com
                                                             // Servidor via socket
        // cliente = new Socket(SimpleServerTest.ENDERECO, SimpleServerTest.PORTA);
        cliente = new Socket(SimpleServerTest.ENDERECO, SimpleServerTest.PORTA);
        System.out.println(" Cliente IP " + SimpleServerTest.ENDERECO + " conectado ao Servidor pela porta "
    ...
    private static void enviaMensagemServidor(String msg) throws IOException { // Objeto para enviar mensagem ao
                                                                               // servidor
    ...
    private static void verificaComunicacao(String echo, String msg) { // Verifica se echo coincide com mensagem
                                                                       // enviada...
        if (echo.equals(msg)) { // echo coincide, portanto, comunicacao OK!
            System.out.println("Comunicacao OK!");
        } else { // echo nao coincide, portanto, comunicacao NOK!
            System.out.println("Comunicacao com problema!");
        }
    }

    public static void encerraConexaoServidor() { // Encerra conexao com o Servidor via socket
